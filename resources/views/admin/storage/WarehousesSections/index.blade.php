                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @php
                                            $i = 1;
                                        @endphp
                                        @foreach ($warehouseSection as $role)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        <div class="flex space-x-2">
                                                            <a href="{{ route('WarehousesSections.location', $role->id) }}"
                                                                class="px-4 py-2 bg-green-500 hover:bg-green-700 text-white rounded-md">Locations</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="flex justify-end">
                                                        <div class="flex space-x-2">
                                                            <a href="{{ route('WarehousesSections.edit', $role->id) }}"
                                                                class="px-4 py-2 bg-blue-500 hover:bg-blue-700 text-white rounded-md">Edit</a>
                                                            <form
                                                                class="px-4 py-2 bg-red-500 hover:bg-red-700 text-white rounded-md"
                                                                method="POST"
                                                                action="{{ route('WarehousesSections.destroy', $role->id) }}"
